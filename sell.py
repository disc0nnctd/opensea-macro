...
def findsellbutton():
    s = pyautogui.locateOnScreen('assets/sellbutton.png')
    while not s:
        sleep(1)
        s = pyautogui.locateOnScreen('assets/sellbutton.png')
...
## Not imlemented properly - for adding properties to already created NFTs on OpenSea    
##def addprop():
##    pyautogui.moveTo(screenWidth-1500, 500)
##    pyautogui.click()
##    
...
##    Enter()
##    Tab()
##    #z = pyautogui.locateOnScreen('assets/polygon.png')
##    #pyautogui.click(z)
